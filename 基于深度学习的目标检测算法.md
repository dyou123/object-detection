...
**生成anchors（feature map的每一个点生成一个anchor） -\> softmax分类器提取anchors -\> bbox reg回归anchors -\> Proposal Layer生成proposals**
...
![avatar](media/20190712111508.png)
...
3. 使用卷积操作的anchor boxes（YOLOv1是生成feature map后接FC，生成目标框类别位置等信息。而V2改进用conv filters来提取生成的anchors的位置偏移和类别，会对mAP造成少量下降，但是recall ratio大量提升）
4. 使用k-means来选取anchor boxes（在目标检测数据集中对所有目标框进行k-means聚类，发现k=5个anchor box最合适）
5. 直接目标框位置检测
6. 细粒度特征的使用
7. 多尺度训练
8. Darknet-19
...
![avatar](C:/Users/magic/Desktop/dyou123git/object-detection/media/bc4fe2b7f1c9f5f02066dfb28d3e5621.png)

同时对类别和位置进行单次预测

![avatar](C:/Users/magic/Desktop/dyou123git/object-detection/media/751b77ba82feb377bb0f5225d71f6de1.png)

使用多尺度特征用于检测

SSD使用卷积网络中较深的层来检测目标。

![avatar](C:/Users/magic/Desktop/dyou123git/object-detection/media/0b01412f0b55dd5bea12f3e389d7dcd0.png)

### 多尺度特征映射

![avatar](C:/Users/magic/Desktop/dyou123git/object-detection/media/401b0cabdaa40a17265d625e6eee0c8c.png)

SSD（右图）获得不同尺寸的特征映射，同时在不同尺寸映射上进行预测，有更多可能性，增加计算量的同时，提高检测精度。

![avatar](C:/Users/magic/Desktop/dyou123git/object-detection/media/231672634cf70ed17a9cdc30e05d8bb5.jpg)
...
![avatar](C:/Users/magic/Desktop/dyou123git/object-detection/media/d3b8c444f92608493226aa0d84c2432c.png)
...
![屏幕快照%202019-05-22%2010.06.25.png](C:/Users/magic/Desktop/dyou123git/object-detection/media/cf0cb13b49eb27f13025126a51e2d7c1.png)
...
![avatar](C:/Users/magic/Desktop/dyou123git/object-detection/media/edd9057275bcc6c4c4163b9be1b2d0ad.jpg)

SSD算法的目标函数分为两部分：计算相应的default box与目标类别的confidence loss以及相应的location loss(位置回归)。

![avatar](C:/Users/magic/Desktop/dyou123git/object-detection/media/d83a197910c6235b925e2a6ecdb44b9b.png)
