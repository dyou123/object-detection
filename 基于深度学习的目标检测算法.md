...
https://blog.csdn.net/scut_salmon/article/details/93887518

mask分支处理ROI得到固定尺寸的14 *14 * 80的feature map（对mask分支的output做resize到14*14）。

针对每个类别，做独热编码，做average binary cross-entropy loss。
